...
PRINT "Read from file || Converter || New file || Write to file"
mov ah, 2
mov dl, 0Dh
int 21h
mov ah, 2
...
handle dw ?
msg db 'Read$'
msg2 db 'Converted to bindechex$'
msg3 db 'Created a file$'
msg4 db 'Written to file$'